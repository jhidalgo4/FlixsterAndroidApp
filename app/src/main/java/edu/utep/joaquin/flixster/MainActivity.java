...
import edu.utep.joaquin.flixster.adapters.MovieAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set to recyclerview to adapter
        ...
        client.get(PLAYING_URL, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try{
                    ...
                    Log.i(LogTag, "Results: "+results.toString() );
                    movies.addAll(Movie.fromJSONArray(results));
                    movieAdapter.notifyDataSetChanged();
                    Log.i(LogTag, "Movies: "+movies.size() );
            ...
            public void onFailure(int statusCode, Headers headers, String response, Throwable throwable) {
                Log.d(LogTag,"onFailure mainActivity");
            }
        });
    }
}
